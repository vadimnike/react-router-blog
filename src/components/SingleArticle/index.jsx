...
<div>
  <div>
    <header className="header header-inverse h-fullscreen pb-80" style={{backgroundImage: 'url(assets/img/bg-cup.jpg)'}} data-overlay={8}>
      <div className="container text-center">
        <div className="row h-full">
          <div className="col-12 col-lg-8 offset-lg-2 align-self-center">
            ...
            <p>
              <img className="rounded-circle w-40" src="assets/img/avatar/2.jpg" alt="..." />
            </p>
          </div>
